...
class AICorrectionInfoViewController: UIViewController {

    override func viewDidLoad() {
        super.viewDidLoad()
        view.backgroundColor = AppColors.bg
        title = L("settings.ai_correction")
        setupUI()
    }
    ...
    private func setupUI() {
        ...
        iconView.tintColor = AppColors.orange
        ...
        descLabel.text = L("ai_correction.description")
